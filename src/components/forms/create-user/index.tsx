            ...
            >
                ...
                {user === undefined && (
                    <Form.Item
                        ...
                        label='Senha'
                        rules={[
                            { required: passwordRequired, message: 'Campo Obrigatório' }
                        ]}
                    >
                ...
                <Form.Item>
                    <Space>
                        <Button type='primary' style={{ backgroundColor: '#a31621' }} onClick={cancel}>Cancelar</Button>
                <Button htmlType='submit' style={{ backgroundColor: '#439A86' }} type='primary'>{user === undefined ? 'Cadastrar' : 'Atualizar'}</Button>
                    </Space>
                </Form.Item>
            </Form>
        </>
