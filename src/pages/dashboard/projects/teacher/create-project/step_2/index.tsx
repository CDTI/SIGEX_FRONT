...
const PartnerShip: React.FC<Props> = ({
  changePartner,
  previous,
  project,
  removeContact,
      ...
      <ContainerFlex>
        <div style={{ width: "100%", maxWidth: "500px" }}>
          {project.partnership?.map((e, index) => (
            <>
              <Form key={index} layout="vertical" style={{ width: "100%", maxWidth: "500px" }}>
                <h2>Parceria {index + 1}</h2>
                <Button type="link" style={{ margin: "8px 0", padding: "0" }} onClick={() => removePartner(index)}>
                  <MinusCircleOutlined />
                  Remover Parceiro
                </Button>
                <Form.Item
                ...
                {e.contacts.length > 0 && (
                  <>
                    {e.contacts.map((contact, indexC) => (
                      <div key={indexC}>
                        <Button
                          onClick={() => removeContact(index, indexC)}
                          type="link"
                ...
                <Button style={{ backgroundColor: "#439A86", color: "#fff" }} onClick={() => addContact(index)} block>
