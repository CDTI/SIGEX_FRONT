                        ...
                        {(fields, { add, remove }) => {
                            return (
                                <div>
                                    ...
                                    {
                                        project.resources.transport.typeTransport.length > 0 && (
                                            <Space style={{ display: 'flex', marginBottom: 8 }}>
                                                ...
                                                <Form.Item
                                                    label='Quantidade'
                                                >
                                                    <Input defaultValue={project.resources.transport.quantity} />
                                                </Form.Item>
                                                <Form.Item
                                                    label='Preço unitário'
                                                >
                                                    <Input defaultValue={project.resources.transport.unitaryValue} />
                                                </Form.Item>
                                            </Space>
                                        )
                                    }
